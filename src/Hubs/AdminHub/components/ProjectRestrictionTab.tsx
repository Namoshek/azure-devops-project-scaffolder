    ...
    <Card className="bolt-card-white" titleProps={{ text: "Template Source Restriction" }}>
      <div className="rhythm-vertical-16" style={{ padding: "8px 0" }}>
        <p className="body-m secondary-text" style={{ margin: 0 }}>
          By default, the Project Scaffolding discovers templates from all projects in this collection. You can restrict
          discovery to specific projects so that only templates from those projects are shown to users.
        </p>
        <p>
          Please be aware that this setting has no impact on the actual permissions required to view templates of a
          project. If a user has no access to a project (or the repositories inside the project) which contains
          templates, then they they will not be able to see the templates regardless of this setting.
        </p>
