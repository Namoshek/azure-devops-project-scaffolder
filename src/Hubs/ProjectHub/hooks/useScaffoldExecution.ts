    ...
    const runOrchestration = async function () {
      ...
      try {
        auditRecordRef.current = await createAuditRecord({
          ...
          templateSourceProjectId: template.sourceProjectId,
          templateSourceRepoId: template.sourceRepoId,
          templateSourceRepoName: template.sourceRepoName,
          templateCommitId: template.sourceCommitId,
          userId: user.id,
